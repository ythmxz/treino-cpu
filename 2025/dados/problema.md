...
A entrada começa com um número $N$ (0 < $N$ <= 10) o número de jogadores, numerados de 1 a $N$. Em seguida há $N$ linhas onde em cada linha está o i−ésimo jogador. Em cada linha há 5 conjunto de números: $(a, b)$, separados por um espaço em branco, onde 1 <= $a$, $b$ <= 6 que são as faces dos dados de cada uma das 5 jogadas.
